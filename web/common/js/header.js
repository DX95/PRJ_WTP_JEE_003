...
//  场景 PRJ-WTP-WEB-030 首页时间显示 创建存放时间的div容器 【3/5  START】
...
document.writeln("						<li><a href=\"../PRJ_WTP_JEE_003_war_exploded/personal_information.jsp\">个人资料</a></li>");
...
// document.writeln("            <div><a href=\"../PRJ_WTP_JEE_003/login.html\">账号：18701721202</div>");
// document.writeln("            <div><a href=\"../PRJ_WTP_JEE_003/login.html\">"+$("#pic").val()+"</div>");
document.writeln("            <div>欢迎您:<a href=\"../PRJ_WTP_JEE_003/login.html\">"+$("#pic").val()+"</div>");
document.writeln("        </div>");

//  场景 PRJ-WTP-WEB-030 首页时间显示 创建当前页面停留时间容器 【4/5  START】
document.writeln("        <div class=\"topbar_login\">");
